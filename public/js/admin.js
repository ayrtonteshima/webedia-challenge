...
var getValue = function getValue(el) {
  return formPosts.querySelector(el).value;
};

var getFormFieldValues = function getFormFieldValues() {
  return {
...
var clearInputsForm = function clearInputsForm() {
  formPosts.querySelectorAll('input[type="text"], textarea').forEach(function (input) {
    input.value = '';
  });
};

var appendNewPostInList = function appendNewPostInList(_ref) {
  var data = _ref.data;
